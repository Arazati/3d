...
$hxClasses["Mesh"] = Mesh;
Mesh.__name__ = true;
Mesh.fromAsset = function(blob) {
	return Mesh.fromString(blob.readUtf8String());
};
Mesh.fromString = function(data) {
	var mesh = new Mesh();
	var points = [];
	...
	while(i < data.length) {
		...
		var str = data.substring(i,endOfLine);
		var split = str.split(" ");
		if(str.length > 0) {
			switch(str.charAt(0)) {
			case "#":
			...
			case "v":
				...
				break;
			default:
				haxe_Log.trace("UNKNOWN MESH PARSE LINE - " + str,{ fileName : "M.hx", lineNumber : 154, className : "Mesh", methodName : "fromString"});
			}
		}
		i = endOfLine + 1;
	}
...
var Main = function() {
	...
	this.depth = new Array(Main.trueWidth * Main.trueHeight);
	this.matProj = new Matrix4x4();
	this.objects = 2;
	this.useLighting = true;
	this.useTriangleColor = true;
	this.useTeapot = true;
...
Main.main = function() {
	...
	var resize = function() {
		canvas.width = Main.trueWidth | 0;
		canvas.height = Main.trueHeight | 0;
		canvas.style.width = window.document.documentElement.clientWidth + "";
		canvas.style.height = window.document.documentElement.clientHeight + "";
	};
	window.onresize = resize;
	resize();
	kha_System.start(new kha_SystemOptions(" ",Main.trueWidth,Main.trueHeight,null,null),function(_) {
...
Main.prototype = {
	...
	,colorBuffer: null
	,start: function() {
		this.meshCube = Mesh.fromAsset(kha_Assets.blobs.VideoShip_obj);
		this.teapot = Mesh.fromAsset(kha_Assets.blobs.teapot_obj);
	...
	,draw: function() {
		...
		if(this.useTeapot && this.teapot != null) {
			mesh = this.teapot;
			pos = new Vec3D(0,0,6);
		}
		...
		while(_g2 < _g3) {
			...
			while(_g21.head != null) {
				...
				if(this.useTriangleColor && tri.col >>> 24 == 255) {
					...
					triProjected.col = kha__$Color_Color_$Impl_$.fromFloats(Math.random(),Math.random(),Math.random());
				}
				if(this.useLighting) {
					var lightDir = new Vec3D(0,0,-1);
					var lightingAmount = Math.abs(lightDir.dotProduct(normal));
					triProjected.col = kha__$Color_Color_$Impl_$.fromFloats(lightingAmount * (this.useTriangleColor ? ((tri.col & 16711680) >>> 16) * 0.00392156862745098 : 1),lightingAmount * (this.useTriangleColor ? ((tri.col & 65280) >>> 8) * 0.00392156862745098 : 1),lightingAmount * (this.useTriangleColor ? (tri.col & 255) * 0.00392156862745098 : 1));
				}
		...
		if(!this.useDepthBuffer || this.highResMode) {
			vecTrianglesToRaster.sort(function(t1,t2) {
				...
				var z2 = (t2.p[0].z + t2.p[1].z + t2.p[2].z) / 3.0;
				if(z1 > z2) {
					return -1;
				} else {
					return 1;
		...
		var _g4 = 0;
		while(_g4 < vecTrianglesToRaster.length) {
			var tri1 = vecTrianglesToRaster[_g4];
			++_g4;
			this.fillTriangle(tri1);
			if(this.wireframeEnabled) {
				this.g2.set_color(-1);
				this.drawTriangle(tri1);
			}
		}
		this.g2.set_color(-1);
	}
	...
	,fillTriangle: function(triangle) {
		if(this.highResMode) {
			if(triangle.col >>> 24 == 255) {
				this.g2.set_color(triangle.col);
			}
	...
	,lowResTriFill: function(triangle) {
		...
		if(dy1 != 0) {
			...
			while(_g < _g1) {
				...
				while(_g2 < _g11) {
					var j = _g2++;
					if(this.depth[j + i * Main.baseWidth] < oneOver || !this.useDepthBuffer) {
						this.drawPixel(j,i);
		...
		if(dy1 != 0) {
			...
			while(_g3 < _g12) {
				...
				while(_g4 < _g13) {
					var j1 = _g4++;
					if(this.depth[j1 + i1 * Main.baseWidth] < oneOver || !this.useDepthBuffer) {
	...
	,texture: null
	,drawPixelFlushToScreen: function() {
	}
	...
	,updateBounds: function() {
		Main.baseWidth = Main.trueWidth / Main.pixelScale | 0;
		Main.baseHeight = Main.trueHeight / Main.pixelScale | 0;
	}
...
var kha__$Assets_ImageList = function() {
	this.names = ["High","Low","T1","T10","T2","T3","T4","T5","T6","T7","T8","T9"];
	this.T9Description = { name : "T9", original_height : 16, file_sizes : [345], original_width : 16, files : ["T9.png"], type : "image"};
	this.T9Name = "T9";
	this.T9 = null;
	this.T8Description = { name : "T8", original_height : 32, file_sizes : [837], original_width : 32, files : ["T8.png"], type : "image"};
	this.T8Name = "T8";
	this.T8 = null;
	this.T7Description = { name : "T7", original_height : 32, file_sizes : [1254], original_width : 64, files : ["T7.png"], type : "image"};
	this.T7Name = "T7";
	this.T7 = null;
	this.T6Description = { name : "T6", original_height : 32, file_sizes : [461], original_width : 32, files : ["T6.png"], type : "image"};
	this.T6Name = "T6";
	this.T6 = null;
	this.T5Description = { name : "T5", original_height : 640, file_sizes : [11199], original_width : 128, files : ["T5.jpg"], type : "image"};
	this.T5Name = "T5";
	this.T5 = null;
	this.T4Description = { name : "T4", original_height : 64, file_sizes : [2601], original_width : 64, files : ["T4.png"], type : "image"};
	this.T4Name = "T4";
	this.T4 = null;
	this.T3Description = { name : "T3", original_height : 128, file_sizes : [7750], original_width : 64, files : ["T3.png"], type : "image"};
	this.T3Name = "T3";
	this.T3 = null;
	this.T2Description = { name : "T2", original_height : 128, file_sizes : [7633], original_width : 64, files : ["T2.png"], type : "image"};
	this.T2Name = "T2";
	this.T2 = null;
	this.T10Description = { name : "T10", original_height : 16, file_sizes : [225], original_width : 16, files : ["T10.png"], type : "image"};
	this.T10Name = "T10";
	this.T10 = null;
	this.T1Description = { name : "T1", original_height : 16, file_sizes : [99], original_width : 16, files : ["T1.png"], type : "image"};
	this.T1Name = "T1";
	this.T1 = null;
	this.LowDescription = { name : "Low", original_height : 256, file_sizes : [67188], original_width : 512, files : ["Low.png"], type : "image"};
	this.LowName = "Low";
	this.Low = null;
	this.HighDescription = { name : "High", original_height : 512, file_sizes : [252956], original_width : 1024, files : ["High.png"], type : "image"};
	this.HighName = "High";
	this.High = null;
};
...
kha__$Assets_ImageList.prototype = {
	...
	,HighLoad: function(done,failure) {
		kha_Assets.loadImage("High",function(image) {
			done();
		},failure,{ fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 126, className : "kha._Assets.ImageList", methodName : "HighLoad"});
	}
	,HighUnload: function() {
		this.High.unload();
		this.High = null;
	...
	,LowName: null
	,LowDescription: null
	,LowLoad: function(done,failure) {
		kha_Assets.loadImage("Low",function(image) {
			done();
		},failure,{ fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 126, className : "kha._Assets.ImageList", methodName : "LowLoad"});
	}
	,LowUnload: function() {
		this.Low.unload();
		this.Low = null;
	...
	,T1Name: null
	,T1Description: null
	,T1Load: function(done,failure) {
		kha_Assets.loadImage("T1",function(image) {
			done();
		},failure,{ fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 126, className : "kha._Assets.ImageList", methodName : "T1Load"});
	}
	,T1Unload: function() {
		this.T1.unload();
		this.T1 = null;
	...
	,T10Name: null
	,T10Description: null
	,T10Load: function(done,failure) {
		kha_Assets.loadImage("T10",function(image) {
			done();
		},failure,{ fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 126, className : "kha._Assets.ImageList", methodName : "T10Load"});
	}
	,T10Unload: function() {
		this.T10.unload();
		this.T10 = null;
	...
	,T2Name: null
	,T2Description: null
	,T2Load: function(done,failure) {
		kha_Assets.loadImage("T2",function(image) {
			done();
		},failure,{ fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 126, className : "kha._Assets.ImageList", methodName : "T2Load"});
	}
	,T2Unload: function() {
		this.T2.unload();
		this.T2 = null;
	...
	,T3Name: null
	,T3Description: null
	,T3Load: function(done,failure) {
		kha_Assets.loadImage("T3",function(image) {
			done();
		},failure,{ fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 126, className : "kha._Assets.ImageList", methodName : "T3Load"});
	}
	,T3Unload: function() {
		this.T3.unload();
		this.T3 = null;
	...
	,T4Name: null
	,T4Description: null
	,T4Load: function(done,failure) {
		kha_Assets.loadImage("T4",function(image) {
			done();
		},failure,{ fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 126, className : "kha._Assets.ImageList", methodName : "T4Load"});
	}
	,T4Unload: function() {
		this.T4.unload();
		this.T4 = null;
	...
	,T5Name: null
	,T5Description: null
	,T5Load: function(done,failure) {
		kha_Assets.loadImage("T5",function(image) {
			done();
		},failure,{ fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 126, className : "kha._Assets.ImageList", methodName : "T5Load"});
	}
	,T5Unload: function() {
		this.T5.unload();
		this.T5 = null;
	...
	,T6Name: null
	,T6Description: null
	,T6Load: function(done,failure) {
		kha_Assets.loadImage("T6",function(image) {
			done();
		},failure,{ fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 126, className : "kha._Assets.ImageList", methodName : "T6Load"});
	}
	,T6Unload: function() {
		this.T6.unload();
		this.T6 = null;
	...
	,T7Name: null
	,T7Description: null
	,T7Load: function(done,failure) {
		kha_Assets.loadImage("T7",function(image) {
			done();
		},failure,{ fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 126, className : "kha._Assets.ImageList", methodName : "T7Load"});
	}
	,T7Unload: function() {
		this.T7.unload();
		this.T7 = null;
	...
	,T8Name: null
	,T8Description: null
	,T8Load: function(done,failure) {
		kha_Assets.loadImage("T8",function(image) {
			done();
		},failure,{ fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 126, className : "kha._Assets.ImageList", methodName : "T8Load"});
	}
	,T8Unload: function() {
		this.T8.unload();
		this.T8 = null;
	...
	,T9Name: null
	,T9Description: null
	,T9Load: function(done,failure) {
		kha_Assets.loadImage("T9",function(image) {
			done();
		},failure,{ fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 126, className : "kha._Assets.ImageList", methodName : "T9Load"});
	}
	,T9Unload: function() {
		this.T9.unload();
		this.T9 = null;
...
var kha__$Assets_BlobList = function() {
	...
	this.teapot_objDescription = { name : "teapot_obj", file_sizes : [210614], files : ["teapot.obj"], type : "blob"};
	this.teapot_objName = "teapot_obj";
	this.teapot_obj = null;
	...
	this.axis_objDescription = { name : "axis_obj", file_sizes : [3973], files : ["axis.obj"], type : "blob"};
	this.axis_objName = "axis_obj";
	this.axis_obj = null;
	this.VideoShip_objDescription = { name : "VideoShip_obj", file_sizes : [2855], files : ["VideoShip.obj"], type : "blob"};
	this.VideoShip_objName = "VideoShip_obj";
	this.VideoShip_obj = null;
	this.Artisans_Hub_objDescription = { name : "Artisans_Hub_obj", file_sizes : [336677], files : ["Artisans Hub.obj"], type : "blob"};
	this.Artisans_Hub_objName = "Artisans_Hub_obj";
	this.Artisans_Hub_obj = null;
	this.Artisans_Hub_mtlDescription = { name : "Artisans_Hub_mtl", file_sizes : [218], files : ["Artisans Hub.mtl"], type : "blob"};
	this.Artisans_Hub_mtlName = "Artisans_Hub_mtl";
	this.Artisans_Hub_mtl = null;
};
...
kha__$Assets_BlobList.prototype = {
	...
	,Artisans_Hub_mtl: null
	,Artisans_Hub_mtlName: null
	,Artisans_Hub_mtlDescription: null
	,Artisans_Hub_mtlLoad: function(done,failure) {
		kha_Assets.loadBlob("Artisans_Hub_mtl",function(blob) {
			done();
		},failure,{ fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 134, className : "kha._Assets.BlobList", methodName : "Artisans_Hub_mtlLoad"});
	}
	,Artisans_Hub_mtlUnload: function() {
		this.Artisans_Hub_mtl.unload();
		this.Artisans_Hub_mtl = null;
	}
	,Artisans_Hub_obj: null
	,Artisans_Hub_objName: null
	,Artisans_Hub_objDescription: null
	,Artisans_Hub_objLoad: function(done,failure) {
		kha_Assets.loadBlob("Artisans_Hub_obj",function(blob) {
			done();
		},failure,{ fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 134, className : "kha._Assets.BlobList", methodName : "Artisans_Hub_objLoad"});
	}
	,Artisans_Hub_objUnload: function() {
		this.Artisans_Hub_obj.unload();
		this.Artisans_Hub_obj = null;
	}
	,VideoShip_obj: null
	,VideoShip_objName: null
	,VideoShip_objDescription: null
	,VideoShip_objLoad: function(done,failure) {
		kha_Assets.loadBlob("VideoShip_obj",function(blob) {
			done();
		},failure,{ fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 134, className : "kha._Assets.BlobList", methodName : "VideoShip_objLoad"});
	}
	,VideoShip_objUnload: function() {
		this.VideoShip_obj.unload();
		this.VideoShip_obj = null;
	}
	,axis_obj: null
	,axis_objName: null
	,axis_objDescription: null
	,axis_objLoad: function(done,failure) {
		kha_Assets.loadBlob("axis_obj",function(blob) {
			done();
		},failure,{ fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 134, className : "kha._Assets.BlobList", methodName : "axis_objLoad"});
	}
	,axis_objUnload: function() {
		this.axis_obj.unload();
		this.axis_obj = null;
	}
	,mountains_obj: null
	,mountains_objName: null
	,mountains_objDescription: null
	,mountains_objLoad: function(done,failure) {
		kha_Assets.loadBlob("mountains_obj",function(blob) {
			done();
		},failure,{ fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 134, className : "kha._Assets.BlobList", methodName : "mountains_objLoad"});
	}
	...
	,sourceWebsiteDescription: null
	,sourceWebsiteLoad: function(done,failure) {
		kha_Assets.loadBlob("sourceWebsite",function(blob) {
			done();
		},failure,{ fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 134, className : "kha._Assets.BlobList", methodName : "sourceWebsiteLoad"});
	}
	,sourceWebsiteUnload: function() {
		this.sourceWebsite.unload();
		this.sourceWebsite = null;
	}
	,teapot_obj: null
	,teapot_objName: null
	,teapot_objDescription: null
	,teapot_objLoad: function(done,failure) {
		kha_Assets.loadBlob("teapot_obj",function(blob) {
			done();
		},failure,{ fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 134, className : "kha._Assets.BlobList", methodName : "teapot_objLoad"});
	}
	,teapot_objUnload: function() {
		this.teapot_obj.unload();
		this.teapot_obj = null;
	}
	,torchic_obj: null
	,torchic_objName: null
	,torchic_objDescription: null
	,torchic_objLoad: function(done,failure) {
		kha_Assets.loadBlob("torchic_obj",function(blob) {
			done();
		},failure,{ fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 134, className : "kha._Assets.BlobList", methodName : "torchic_objLoad"});
	}
	,torchic_objUnload: function() {
		this.torchic_obj.unload();
		this.torchic_obj = null;
	}
	,names: null
